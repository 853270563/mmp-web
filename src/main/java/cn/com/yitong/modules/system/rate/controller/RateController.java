package cn.com.yitong.modules.system.rate.controller;
...
import cn.com.yitong.modules.system.rate.service.RateService;
import cn.com.yitong.util.YTLog;

@Controller
public class RateController extends BaseControl {
	...
	final String BASE_PATH = "system/rate/";

	@Autowired
	private RateService rateService;

	@RequestMapping("system/rate/queryRateInfo.do")
	@ResponseBody
	public Map queryRateInfo(HttpServletRequest request) {
		String trans_code = "queryRateInfo";
		...
		try {
			// 数据库操作
			rst.putAll(rateService.queryRateInfo(params));
