	...
	<div id="TEST_PANEL" align="center">
		<div align="left" style="padding:10px 0px 0px 10px;height:50px;">
			<ul class="group trans_model" data-name="MODO_TYPE" data-group="MODO_TYPE" data-label="模塊">
				<li data-value="YDYX" class="selected">全部服务</li>
				<li data-value="PP10">01 业务包管理</li>
				<li data-value="PP11">02 产品货架</li>
				<li data-value="PP12">03 工具管理</li>
				<li data-value="PP13">04 信息服务</li>
				<li data-value="PP14">05 移动信贷</li>
				<li data-value="PP15">06 智慧厅堂</li>
				<li data-value="PP16">07 开卡签约</li>
			</ul>
		</div> 
		<hr>
