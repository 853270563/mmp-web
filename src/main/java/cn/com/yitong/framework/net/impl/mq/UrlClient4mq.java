...
@Component
public class UrlClient4mq implements IClientFactory {

	private Logger logger = YTLog.getLogger(this.getClass());

	// private final String serverURL = ServerInit.getString("MB_SERVER_URL");
	private final String serverURL = "http://172.31.252.205:7800/TFBService";
	...
	public static void main(String[] args) {
		IClientFactory client = new UrlClient4mq();
