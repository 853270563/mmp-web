...
@Controller
public class CheckBussiCardStatus extends BaseControl {
	 ...
	 * @return
	 */
	@RequestMapping("jjk/openCard/list/CheckBussiCardStatus.do")
	@ResponseBody
	public Map list(String trans_code, HttpServletRequest request) {
		String transCode = BASE_PATH+"CheckBussiCardStatus";
		Map rst = new HashMap();
		// 初始化数据总线
