...
@Component
public class SocketFactory4esbTest implements IClientFactory {
	...
	public boolean execute(IBusinessContext busiCtx, String transCode) {
		...
		try {
			...
			String filePath = System.getProperty("mmp.root") + "/WEB-INF/data//ytbank/esb/"+transCode + ".txt";
	...
	public static void main(String[] args) {
		SocketFactory4esbTest factory = new SocketFactory4esbTest();
