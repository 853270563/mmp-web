package cn.com.yitong.modules.system.banner.controller;
...
@Controller
public class BannerDataController extends BaseControl {
	...
	final String BASE_PATH = "system/banner/";

	@RequestMapping("system/banner/bannerDataList.do")
	@ResponseBody
	public Map bannerDataList(HttpServletRequest request) {
		String trans_code = "bannerDataList";
		...
		try {
			// 数据库操作
			List datas = service.findList("MZJ_BANNER_DATA.pageQuery", params);
