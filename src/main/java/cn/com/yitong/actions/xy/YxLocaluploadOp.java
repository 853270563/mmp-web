...
*/
@Service
public class YxLocaluploadOp implements IAresSerivce {
	...
	public int execute(IBusinessContext ctx) {
		...
		String TASK_ID = ctx.getParam("TASK_ID");
		String BUSI_FILE_TYPE = ctx.getParam("BUSI_FILE_TYPE");
		List<String> imagePaths = new ArrayList<String>();
		for (Map<String, Object> map : paramDatas) {

			String path = ImageUtil.GenerateImage((String) map.get("IMG_BASE64"), TASK_ID, BUSI_FILE_TYPE);
			imagePaths.add(path);
		}
