 ...
 */
@Component
public class ChangeBannerFileUrlOp extends AbstractOp implements IAresSerivce {
	...
	public int execute(IBusinessContext ctx) {
		...
		if (rs != null && rs.size() != 0) {
			for (Map map : rs) {
				map.put("BANNER_PIC_ADDR","download/userResource/file.do?fileName="+ map.get("BANNER_PIC_ADDR"));
