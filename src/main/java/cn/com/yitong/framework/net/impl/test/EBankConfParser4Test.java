package cn.com.yitong.framework.net.impl.test;
 ...
 */
@Component
public class EBankConfParser4Test implements IEBankConfParser {
	...
	private boolean isListItem(MBTransItem item) {
		return EBankConst.FILED_TYPE_E.equals(item.getType()) || EBankConst.FILED_TYPE_M.equals(item.getType());
	}
