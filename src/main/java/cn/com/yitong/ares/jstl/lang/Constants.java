...
public class Constants {
	...
	static ResourceBundle sResources = ResourceBundle.getBundle("cn.com.yitong.ares.jstl.lang.Resources",
			Locale.ENGLISH);
	...
	public static String getStringResource(String pResourceName) throws MissingResourceException {
		try {
			...
			if (ret == null) {
				...
				throw new MissingResourceException(str, "org.apache.taglibs.standard.lang.jstl.Constants",
						pResourceName);
			} else {
				return ret;
			}
