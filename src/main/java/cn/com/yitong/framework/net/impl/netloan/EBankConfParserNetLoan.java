 ...
 */
@Component
public class EBankConfParserNetLoan implements IEBankConfParser {
	private Logger logger = YTLog.getLogger(EBankConfParserNetLoan.class);
