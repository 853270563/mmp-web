...
@Component
public class SocketFactory4creditTest implements IClientFactory {
	...
	public boolean execute(IBusinessContext busiCtx, String transCode) {
		...
		try {
			...
			String filePath = System.getProperty("mmp.root") + "/WEB-INF/data//ytbank/"+transCode + ".txt";
	...
	public static void main(String[] args) {
		SocketFactory4creditTest factory = new SocketFactory4creditTest();
