 ...
 */
@Component
public class EBankConfParser4mqtest implements IEBankConfParser {
	private Logger logger = YTLog.getLogger(this.getClass());

	private SAXReader reader;
	String rootpath = "D:/works/push_space/ibanking/WebContent/WEB-INF/conf/mq/";

	public EBankConfParser4mqtest() {
