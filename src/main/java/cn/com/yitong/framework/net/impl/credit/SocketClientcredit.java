 ...
 * 
 */
public class SocketClientcredit {

	static Logger logger = YTLog.getLogger(SocketClientcredit.class.getName());
	...
	private final int LENGTH = CreditConst.LENGTH;

	public SocketClientcredit() {
	}
