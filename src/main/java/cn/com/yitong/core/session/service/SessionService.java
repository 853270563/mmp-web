...
public class SessionService {
	...
	//LOGIN 用户不存在
	public static final String LOGIN_STATUS_EVENT_NO_USER = "100110";
	//用户登录失败，失败原因:密码错误超过5次已被锁定, 请联系系统管理员解锁!
	public static final String LOGIN_STATUS_EVENT_USER_LOCK = "100111";
	//密码错误, 登录失败
	public static final String LOGIN_STATUS_EVENT_RROR_PWD = "100112";
	//您是后管平台用户，无权限登陆客户端
	public static final String LOGIN_STATUS_EVENT_ERROR_TYPE = "100113";
