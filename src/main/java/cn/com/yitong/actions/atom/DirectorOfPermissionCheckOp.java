...
*/
@Service
public class DirectorOfPermissionCheckOp implements IAresSerivce {
	...
	public int execute(IBusinessContext ctx) {
		...
		List<String> queryForList = ibatisDao.queryForList(ctx.getParam("*queryForList"), userId);
