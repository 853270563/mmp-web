...
@Component
public class SocketFactory4credit implements IClientFactory {
	...
	public boolean execute(IBusinessContext busiCtx, String transCode) {
		...
		try {
			...
			busiCtx.setErrorInfo(AppConstants.STATUS_FAIL, e.getMessage(), transCode);
	...
	public static void main(String[] args) {
		SocketFactory4credit factory = new SocketFactory4credit();
