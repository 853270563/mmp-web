 ...
 */
@Component
public class NetTools4crm implements INetTools {

	@Autowired
	@Qualifier("requestBuilder4crm")
	IRequstBuilder requestBuilder;

	@Autowired
	@Qualifier("EBankConfParser4crm")
	IEBankConfParser confParser;

	@Autowired
	@Qualifier("socketFactory4crm")
	protected IClientFactory clientFactory;

	@Autowired
	@Qualifier("responseParser4crm")
